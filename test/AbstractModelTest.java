...
public abstract class AbstractModelTest {
  ...
  FreecellModel<Card> game1A;
  FreecellModel<Card> game1B;
  FreecellModel<Card> game2unshuffled;
  FreecellModel<Card> game2shuffled;
  FreecellModel<Card> game3;
  List<Card> validDeck;
  List<Card> invalidDeck1;
  List<Card> invalidDeck2;

  protected abstract FreecellModel<Card> generateModel();

  @Before
  public void setup() {
    game1A = this.generateModel();
    game1B = this.generateModel();

    game2unshuffled = this.generateModel();
    game2unshuffled.startGame(game2unshuffled.getDeck(), 8, 4, false);

    game2shuffled = this.generateModel();
    game2shuffled.startGame(game2shuffled.getDeck(), 8, 4, true);

    game3 = this.generateModel();
