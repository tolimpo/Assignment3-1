...
public class MultimoveModelTest {
  MultimoveModel game1A;
  MultimoveModel game1B;
  MultimoveModel game2unshuffled;
  MultimoveModel game2shuffled;
  MultimoveModel game3;
  List<Card> validDeck;
  ...
  @Before
  public void setup() {
    game1A = new MultimoveModel();
    game1B = new MultimoveModel();

    game2unshuffled = new MultimoveModel();
    game2unshuffled.startGame(game2unshuffled.getDeck(), 8, 4, false);

    game2shuffled = new MultimoveModel();
    game2shuffled.startGame(game2shuffled.getDeck(), 8, 4, true);

    game3 = new MultimoveModel();
  ...
  // TODO New tests for Multimove model start here.
